...
To run the ResearcherPlots flow, use the following command:
    ...
    $ python -m eic_case_studies.pipeline.cs2.analysis.researchers_plot_flow --environment pypi run
...
class ResearcherPlots(FlowSpec):
    ...
    def start(self):
        ...
        # change the status for researchers that have a proposal_call_id other than NOT_EIC and that currently have a status of NOT_EIC to NO_DATA
        self.researchers_results.loc[
            (self.researchers_results["proposal_call_id"] != "NOT_EIC")
            & (self.researchers_results["status"] == "NOT_EIC"),
            "status",
        ] = "NO_DATA"
    ...
    def create_table(self):
        ...
        tbl.set_fontsize(12)
        plt.savefig(
            "eic_case_studies/data/06_outputs/researchers/00_researcher_table.png",
            dpi=400,
            bbox_inches="tight",
        )
    ...
    def create_boxplot(self):
        ...
        # drop proposal_call_id that is NOT_EIC
        self.results_cp_bp = self.results_cp[
            self.results_cp["proposal_call_id"] != "NOT_EIC"
        ]

        # Create a box plot for each proposal_call_id
        create_whisker_boxplot(order, "all", self.results_cp_bp)
        create_whisker_boxplot(order, "before", self.results_cp_bp)
        create_whisker_boxplot(order, "after", self.results_cp_bp)
    ...
    def create_wbox_status_plot(self):
        ...
        # exclude status NOT_EIC
        self.results_cp = self.results_cp[self.results_cp["status"] != "NOT_EIC"]
    ...
    def create_error_bar_plots(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/04_error_bar_plots.png", "wb"
        ) as f:
            f.write(png_str)
    ...
    def create_error_bar_plots_citations(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/04_error_bar_plots_citations.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_error_bar_plots_publications(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/04_error_bar_plots_publications.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_density_subset(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/05_density_subplot.png", "wb"
        ) as f:
            f.write(png_str)
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/05_density_subplot_cited_by_count_std.png",
            "wb",
        ) as f:
            f.write(png_str)
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/05_density_subplot_publication_count_std.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_publications_scatter(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/06_scatterplot_publications_count_std.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_citations_scatter(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/06_scatterplot_cited_by_count_mean.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_scatter_citations_div(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/06_scatterplot_div_mean_cited_by_count_mean.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_scatter_publications_div(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/06_scatterplot_div_mean_publications_count_std.png",
            "wb",
        ) as f:
            f.write(png_str)
    ...
    def create_scatter_div_before_after(self):
        ...
        with open(
            "eic_case_studies/data/06_outputs/researchers/06_scatterplot_div_mean_before_after.png",
            "wb",
        ) as f:
            f.write(png_str)
...
def create_whisker_boxplot(order, label, results):
    ...
    with open(
        f"eic_case_studies/data/06_outputs/researchers/01_whisker_box_plot_{label}.png",
        "wb",
    ) as f:
        f.write(png_str)
...
def density_plot(results, mean_values, label):
    ...
    chart_variety = (
        alt.Chart(results)
        .transform_density("variety", as_=["variety", "density"], groupby=["status"], extent=[0, 0.025])
        .mark_area(opacity=0.5)
        .encode(
            x="variety:Q",
            y="density:Q",
    ...
    with open(
        f"eic_case_studies/data/06_outputs/researchers/02_density_plot_{label}.png",
        "wb",
    ) as f:
        f.write(png_str)
...
def create_wbox_status(results, label):
    ...
    with open(
        f"eic_case_studies/data/06_outputs/researchers/03_whisker_box_status_plot_{label}.png",
        "wb",
    ) as f:
        f.write(png_str)
