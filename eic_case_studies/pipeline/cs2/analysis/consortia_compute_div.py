"""This module contains the Metaflow flow for calculating diversity metrics for researchers' consortia.
    ...
    To run the DiversityFlow flow, use the following command:
        ...
        $ python -m eic_case_studies.pipeline.cs2.analysis.consortia_compute_div --environment pypi run --save_to_s3 True
"""
